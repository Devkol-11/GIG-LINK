...
class ResetPasswordController {
    ...
    async Execute(req, res, next) {
        try {
            ...
            const response = await this.resetPasswordUseCase.Execute(token, password);
...
exports.resetPasswordController = new ResetPasswordController(ResetPasswordUseCase_1.resetPasswordUseCase);
