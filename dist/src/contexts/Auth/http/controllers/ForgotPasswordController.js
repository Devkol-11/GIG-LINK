...
class ForgotPasswordController {
    ...
    async Execute(req, res, next) {
        try {
            ...
            const response = this.forgotPasswordUseCase.Execute(email);
...
exports.forgotPasswordController = new ForgotPasswordController(ForgotPasswordUseCase_1.forgotPasswordUseCase);
