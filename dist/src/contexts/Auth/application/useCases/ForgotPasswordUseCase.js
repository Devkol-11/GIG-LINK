...
class ForgotPasswordUseCase {
        ...
        async Execute(DTO) {
                ...
                const tokenEvent = new PasswordResetEvent_1.PasswordResetEvent(
                        tokenData.id,
                        tokenData.userId,
                        tokenData.token
                );
                await this.eventPublisher.publish(
                        tokenEvent.routing_key,
                        tokenEvent
                );
                return {
...
exports.forgotPasswordUseCase = new ForgotPasswordUseCase(
        AuthRepository_1.authRepository,
        passwordResetTokenRepository_1.passwordResetTokenRepository,
