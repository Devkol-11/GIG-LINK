...
import { EscrowStatus, PaymentChannel, PaymentDirection, PaymentProvider, PaymentStatus, TransactionSource, TransactionStatus, TransactionType, WalletStatus, } from "../../prisma/generated/prisma/enums.js";
...
export const billingRepository = {
    ...
    async markPaymentSuccessful(reference) {
    ...
    createOrUpdateWalletRecipient(userId, data) {
    ...
    async getWalletPayments(userId) {
    ...
    getWalletByIdForUser(userId, walletId) {
    ...
    async createWithdrawalTransaction(walletId, amount) {
    ...
    async creditFreelancerWallet(userId, amountKobo) {
