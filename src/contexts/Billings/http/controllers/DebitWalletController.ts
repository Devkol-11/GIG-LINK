...
import {
  DebitWalletUseCase,
  debitWalletUseCase,
} from "../../application/useCases/DebitWalletUseCase.js";
import { Request, Response } from "express";
import { sendResponse } from "@src/shared/helpers/sendResponse.js";
import { httpStatus } from "@src/shared/constants/httpStatusCode.js";
import { BadRequest } from "@src/shared/errors/baseErrors.js";

export class DebitWalletController {
  constructor(private debitWalletUseCase: DebitWalletUseCase) {}
  ...
  Execute = catchAsync(async (req: Request, res: Response) => {
    ...
    const data = await this.debitWalletUseCase.Execute(walletId, amount);
