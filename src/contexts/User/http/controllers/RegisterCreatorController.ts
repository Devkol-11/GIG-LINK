...
export class RegisterCreatorController {
        constructor(private readonly registerCreatorUseCase: RegisterCreatorUseCase) {}
...
export const registerCreatorController = new RegisterCreatorController(registerCreatorUseCase);
